...
export default function Login() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-100 bg-opacity-80 min-h-screen">
      ...
      <div className="relative z-10 w-full max-w-md mx-auto bg-gradient-to-b from-blue-400 to-blue-200 rounded-[48px] shadow-xl p-8 flex flex-col items-center">
        {/* Close Button */}
        <button
